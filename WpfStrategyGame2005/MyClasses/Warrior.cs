...
namespace WpfStrategyGame2005.MyClasses
{
    ...
    {
        public Warrior(string name, string photo, ObservableCollection<Weapon> weapons, ObservableCollection<Chest> chests, int strength, int dexterity, int intelligence, int vitality, int points)
            : base(name, photo, weapons, chests, strength, dexterity, intelligence, vitality, 250, 80, 50, 100, points)
        {
            Points = 50;
        }
